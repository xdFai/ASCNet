...
# parser.add_argument('--cleanfilename', type=str, default=r'D:\SCI012\Test\Images\CVC14', help="the path of clean image")
parser.add_argument('--cleanfilename', type=str, default=r'D:\SCI012\Test\Noise_mix\CVC14', help="the path of clean image")
parser.add_argument('--generatefilename', type=str, default=r'D:\SCI012\Test\Noise_mix\CVC14_2',
...
for i in clist:
    ...
    if case == 0:
        ...
        noise_col = np.random.normal(0, beta, sizeN_S[1])
        ...
        beta3 = np.random.uniform(noiseB_N[0], noiseB_N[1])  #

        # A1 = np.random.normal(0, beta1, sizeN_S[1])  # 一行向量
        # A2 = np.random.normal(0, beta2, sizeN_S[1])  # 一行向量
        A3 = np.random.normal(0, beta3, sizeN_S)  #
        # # 拉伸
        ...
        A1 = np.random.normal(0, beta1, sizeN_S[1])  # 一行向量
        A2 = np.random.normal(0, beta2, sizeN_S[1])  # 一行向量
        A3 = np.random.normal(0, beta3, sizeN_S[1])  # 一行向量
        # 拉伸
        A1 = np.tile(A1, (sizeN_S[0], 1))
        A2 = np.tile(A2, (sizeN_S[0], 1))
        ...
        A2 = np.random.normal(0, beta2, sizeN_S[1])  # 一行向量
        A3 = np.random.normal(0, beta3, sizeN_S[1])  # 一行向量
        A4 = np.random.normal(0, beta4, sizeN_S[1])  # 一行向量
        # 拉伸
        A1 = np.tile(A1, (sizeN_S[0], 1))
        A2 = np.tile(A2, (sizeN_S[0], 1))
        A3 = np.tile(A3, (sizeN_S[0], 1))
